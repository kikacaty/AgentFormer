...
do
    ...
    do
        ...
        do
            ...
            BASENAME="step_${STEP}_${EPS}_lr_${LR} ml.model.adv_agentformer"

            WS_ID=yulong-avg # replace with your workspace ID


            NAME="finetune_qz_reg-$BASENAME"
            ...
            CMD="${CMD} \ 
                ...
                --pgd_step $STEP --eps $EPS --test_pgd_step 20 --qz_reg --ngc --finetune_lr $LR\
