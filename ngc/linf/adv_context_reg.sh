    ...
    do
        ...
        do
            ...
            do
                ...
                BASENAME="step_${STEP}_eps_${EPS}_lr_${LR}_beta_${BETA} ml.model.adv_agentformer"

                WS_ID=yulong-avg # replace with your workspace ID


                NAME="${BASENAME}.context_reg.all"
                ...
                CMD="${CMD} \ 
                    ...
                    --pgd_step $STEP --eps $EPS --test_pgd_step 20 --context_reg --ngc --context_reg_beta $BETA --all"
                ...
                NAME="${BASENAME}.context_reg.finetune.all"
                CMD="cd /workspace/adv_pred/; git pull; \
                    apt-get update && apt-get install libgl1 -y; \
                    pip install -r requirements.txt;\
                    pip install wandb; wandb login 66e53af18f876c79bad2f274a73b1c8026ced2ef; \
                ...
                CMD="${CMD} \ 
                    python adv_train.py --cfg adv_mini_nusc_5sample_pre --adv_cfg at_noise \
                    --pgd_step $STEP --eps $EPS --test_pgd_step 20 --context_reg --ngc --context_reg_beta $BETA"
                ...
                NAME="${BASENAME}.context_reg.finetune"
                CMD="cd /workspace/adv_pred/; git pull; \
                    apt-get update && apt-get install libgl1 -y; \
                    pip install -r requirements.txt;\
                    pip install wandb; wandb login 66e53af18f876c79bad2f274a73b1c8026ced2ef; \
