    ...
    do
        ...
        do
            ...
            do
                ...
                BASENAME="step_${STEP}_${EPS}_${EPOCH}_${BETA} ml.model.adv_agentformer"

                WS_ID=yulong-avg # replace with your workspace ID


                NAME="DLOW-finetune-qz_reg-$BASENAME"
                ...
                CMD="${CMD} \ 
                    ...
                    --exp_name finetune_0.1/qz_reg_${BETA}/eps_${EPS}_step_${STEP}_free_False_amp_False_fixed_False_qz_False_adv \
