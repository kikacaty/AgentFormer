        ...
        do
            ...
            CMD="${CMD} \ 
                python test.py --cfg adv_mini_nusc_5sample \
                                ...
                                finetune_0.1/qz_reg/eps_0.5_step_${STEP}_free_False_amp_False_fixed_False_qz_False_adv --pred_epoch ${EPOCH} --adv;\
                python test.py --cfg adv_mini_nusc_5sample \
                                --eps 0.5 --pgd_step 20 --ngc\
                                finetune_0.1/qz_reg/eps_0.5_step_${STEP}_free_False_amp_False_fixed_False_qz_False_adv --pred_epoch ${EPOCH}; "
